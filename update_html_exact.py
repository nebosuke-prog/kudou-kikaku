...
# We will just replace everything between <body> and <!-- About Us Section -->
# Since we know the layout we want.
...
text = re.sub(r'<body.*?>.*?<!-- About Us Section -->', new_top, text, flags=re.DOTALL | re.IGNORECASE)

with open('index.html', 'w', encoding='utf-8') as f:
    f.write(text)

print("HTML forcefully updated.")
